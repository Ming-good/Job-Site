	...
	<div class="col-md-offset-1 col-md-10">
	    ...
	    <h3 style="font-weight:bold; margin-top:40px;">자기소개서</h3>
            <div class="form-group">
                <input value="<?php echo e($data['title']); ?>" style="height:50px;text-align:center;" type="text" class="form-control" name="inputTitle" id="inputTitle" placeholder="이력서 제목을 입력해주세요.">
	    </div>
	    <div class="form-group">
